...
function StudentDashboard() {
  ...
  const handleNavigateToJoinClass = () => {
    navigate("/join-class");
  };
  ...
  const handleNavigateToStudentAttendance = () =>{
    navigate("/student-attendance");
  }

  return (
    <ThemeProvider theme={theme}>
      <div style={dashboardContainerStyle} ref={componentRef}>
        <StudentHeader />
              ...
              <table style={{ width: "100%" }}>
                <thead>
                  <tr>
                    ...
                    <th style={{ border: "1px solid #333", padding: "8px", textAlign: "left" }}>Location</th>
                  </tr>
                </thead>
                <tbody>
                  {classInfo.map((classItem) => (
                    <tr key={classItem.id}>
                      ...
                      <td style={{ border: "1px solid #333", padding: "8px", textAlign: "left" }}>{classItem.subject}</td>
                      <td style={{ border: "1px solid #333", padding: "8px", textAlign: "left" }}>{classItem.location}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div style={additionalContentWrapperStyle}>
            <div style={additionalContentContainerStyle}>
              <div style={verticalContentStyle}>
                <p>Track</p>
                <Button variant="contained" color="primary" style={buttonStyling} onClick={handleNavigateToStudentAttendance}>
                  Attendance Sheet
                </Button>
              </div>
              <div style={verticalContentStyle}>
        ...
        <div style={buttonbox}>
          <Button
            ...
            onClick={handleNavigateToStudentDetails}
          >
            CLASS DETAILS
          </Button>
          <Button
            ...
            style={buttonDesign}
            endIcon={<img src={PlayIcon} alt="play" style={playIconStyle} />}
            onClick={handleNavigateToJoinClass}
          >
            JOIN CLASS
          </Button>
          <Button
